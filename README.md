...
-  This notebook demonstrates how to use string methods (like .split() and .join()), list manipulations, and the built-in statistics module to process and analyze data collections. It shows how to convert between strings and lists, clean or transform data, and apply simple statistical summaries — combining fundamental programming tools for practical data-handling workflows.
...
-  This notebook serves as an introduction to NumPy and showcases foundational usage of NumPy arrays — how to create arrays, manipulate them, and leverage NumPy’s advantages over Python native lists for numerical and array-based data.
